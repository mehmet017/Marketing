...
public class Exceptions05 {
    ...
    public static void main(String[] args) {
        ...
        //Coklu "catch" kullandiginizda Exception Class'lar arasinda "parent-child" iliskisi yoksa,
        //catch'lerin sirasi onemli degildir. Ama kod'daki siralamaya uymak tavsiye edilir.
        //Coklu "catch" kullandiginizda Exception Class'lar arasinda "parent-child" iliskisi varsa,
        //catch'lerin sirasi onemlidir, child olan class ustte olmalidir.
