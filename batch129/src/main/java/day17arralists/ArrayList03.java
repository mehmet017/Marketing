...
public class ArrayList03 {
    public static void main(String[] args) {
        ...
        //remove() methodu index ile kullanilirsa sildigi elemani verir
        ...
        //remove() methodu ile kullanilirsa size o elemani silip silmedigini ifade eden true veya false verir.
