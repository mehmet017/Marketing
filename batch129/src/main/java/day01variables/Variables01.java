...
public class Variables01 {
    public static void main(String[] args) {
        ...
        //Access Modifier yazmassaniz "access modifier" "default" demektir.
        //Data Type + Variable Name ==> Variable Declaration
        //Assignment Operator(Atama Operatoru) + Variable Degeri ==>Assignment
        //Eger Variable Declaration yapar, Assignment yapmazsaniz java kendi degerlerini(default0 koyar.
        //Default degerler sayilar icin sifirdir
        //Data Type' ini yaziniz Variable ismi yaziniz Assignment Operator(Atama Operator) Variable degeri Ingilizcede ki nokta gibi
        int              age           =                     13              ;
        //Ornek 1: Ogrenci ismi icin variable olusturup deger olarak Ali Can atayiniz.
        //String'lere verilen degerler cift tirnak icnde olmalidir.
