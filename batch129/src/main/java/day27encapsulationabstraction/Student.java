...
public class Student {
    ...
    // get method'larin(getter) data type "boolean" ise "is+ variable name" seklinde olur.
    ...
    //Encansulation yapilmis data'larin degeri degistirilebilir mi?
    //set method'lar(setter) encapsulation yapilmis data'larin degerlerin degistirmemize yarar.
    // set method'lar(setter) her zaman "public" olur
    // get method'larin(getter) return type'i her zaman void olur.
