...
public abstract class Courses {
    ...
    /*
        ...
        2)"abstroct method"lar child class'lar tarafindan "override" edilmek zorundadirlar.
          Bu yuzden, eger bir fonksiyonun child class'lar tarafindan kullanilmasini mecbur kilmak isterseniz
          o method'u abstroct yapmak gerekir.
        ...
        4)"abstract method"lar siradan class'larin icine yazilmazlar, "abstroct method" larin icine yazildiklari class'larin
    ...
    //final method'lar "override" edilemezler, halbuki "abstroct" method'lar override edilmek icin olusturulurlar.
    //Bu celiskidir, bu yuzden Java abstract method'larin final olmasina musaade etmez .
    //public final abstract void science();

    //Concrete Class'lar final oludgunda Child Class'a sahip olamazlar
    //Ama "Abstract Class" lar icin Child Class olmalidir,
    //cunku Child Class'lar abstract parent class'daki abstract method'lari kullanirlar
